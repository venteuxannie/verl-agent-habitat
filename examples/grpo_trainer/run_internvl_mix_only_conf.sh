...
OUTPUT_DIR="./rollouts_logs/sft_grpo_internvl-mix_tasks-only_conf-11_10"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/data1/tct_data/sft-model/InternVL3_5-2B-mixed-tasks-sft \
    ...
    trainer.experiment_name='sft_grpo_internvl-mix_tasks-only_conf-11_10' \
