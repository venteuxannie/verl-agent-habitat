...
OUTPUT_DIR="./rollouts_logs/sft_grpo_internvl-mix_tasks-rl_only-11_09"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/data1/tct_data/InternVL/models/InternVL3_5-2B-GIT \
    ...
    trainer.experiment_name='sft_grpo_internvl-mix_tasks-rl_only-11_09' \
