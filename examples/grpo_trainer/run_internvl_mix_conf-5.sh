...
OUTPUT_DIR="./rollouts_logs/sft_grpo_internvl-mix_tasks-conf_5-11_11"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/data/tct/models/SFT/InternVL3_5-2B-mixed-tasks-sft \
    ...
    trainer.experiment_name='sft_grpo_internvl-mix_tasks-conf_5-11_11' \
