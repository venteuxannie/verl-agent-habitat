...
class BaseModelMerger(ABC):
    ...
    def get_transformers_auto_model_class(self):
        ...
        elif "InternVL" in self.model_config.architectures[0] or self.model_config.architectures[0] in ["InternVLChatModel"]:
            # InternVL models use AutoModelForImageTextToText
