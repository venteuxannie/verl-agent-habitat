...
class BasicPreprocessor:
    """Base preprocessor class for multi-modal data processing."""
    ...
    def process_image(self, image, **kwargs):
        ...
        Args:
            image: Image data (PIL.Image, path, URL, etc.)
    ...
    def process_video(self, video, **kwargs):
        ...
        Args:
            video: Video data (dict with video path/frames, etc.)
            **kwargs: Additional processing parameters
    ...
    def process_audio(self, audio, **kwargs):
        ...
        """
        raise NotImplementedError("The process_audio method must be implemented")

    def __call__(self, messages, row_dict):
        """Process messages and multi-modal data.
        
        Args:
            messages: List of message dicts with role and content
            row_dict: Dict containing multi-modal data (images, videos, etc.)
